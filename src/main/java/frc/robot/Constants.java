...
public final class Constants {
    public static final class DriveConstants {
      ...
      */
      ...
      public static final int[] kRightEncoderPorts = new int[]{4, 5};
    */
      public static final int[] kLeftEncoderPorts = new int[]{0, 1};
      ...
      //public static final double kTrackwidthFeet = 2.395;
      public static final DifferentialDriveKinematics kDriveKinematics =
          new DifferentialDriveKinematics(kTrackwidthMeters);
  
      public static final int kEncoderCPR = 2048;
      public static final double kWheelDiameterMeters = 0.1524;
      //public static final double kWheelDiameterFeet = 0.333;
      ...
      /*
      public static final double ksVolts = 1.78;
      public static final double kvVoltSecondsPerMeter = 1.79;
      public static final double kaVoltSecondsSquaredPerMeter = 0.426;
      */

      public static final double ksVolts = 0.57;
      public static final double kvVoltSecondsPerMeter = 3.14;
      public static final double kaVoltSecondsSquaredPerMeter = 0.513;
